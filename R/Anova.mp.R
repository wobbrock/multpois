...
#' the given model.
#'
#' @param model A model built by \code{\link{glm.mp}} or \code{\link{glmer.mp}}. The underlying model is
#' built by \code{\link[stats]{glm}} or \code{\link[lme4]{glmer}}, both with \code{family=poisson}.
#'
#' @param type Type \code{type} parameter passed to \code{\link[car]{Anova}}. Default is type 3.
#'
...
#' \code{\link{glmer.mp}}, respectively.
#'
...
#' In general, the results should be very close or match.
#'
